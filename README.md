...
Following are steps you can use to download, build, and run the JompTree example program. First obtain a local copy of this repo. The following code blocks include the MacOS terminal window console prompt, commands you type, and the resulting output. Everything shown here also works on Linux and Windows with minor adjustments:
```
...
```
Run the program with arguments to see generated Java code on the console. The comment text at the end of each line gives the count of leaf nodes and the count of branch levels in that line:
```
MarksiMac:JompTree williamm$ java JompTree Jbrnch.txt Jleaf.txt
